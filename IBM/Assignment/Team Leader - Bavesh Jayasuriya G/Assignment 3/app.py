...
COS_API_KEY_ID = "fDuv-mL8y30SDvGs_mG-BGjWeSrSYXT2Mj7iNf7BKjQH"
COS_INSTANCE_CRN = "crn:v1:bluemix:public:cloud-object-storage:global:a/870cd186abe443a38c10533f71e00157:11e43fa8-e1ad-4236-b1e6-a8385ef2cffe::"
...
@app.route('/')
def index():
    files = get_bucket_contents('flaskapp-by-akaash')
